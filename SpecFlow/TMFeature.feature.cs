...
namespace SeleniumSpecFlow.SpecFlow
{
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "SpecFlow", "TMFeature", "As a TurnUp portal admin\r\nI would like to Create, Edit and Delete Time and Materi" +
                    "al Records\r\nTo Manage employee\'s time and material successfully", ProgrammingLanguage.CSharp, ((string[])(null)));
...
#line hidden
#line 11
 testRunner.When("I created Time and Material record", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 12
...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("parrot", "keyboard", "10", null)]
        [NUnit.Framework.TestCaseAttribute("pigeon", "mouse", "20", null)]
        [NUnit.Framework.TestCaseAttribute("ostrich", "pen", "30", null)]
...
#line hidden
#line 18
 testRunner.Then(string.Format("time and material should have updated \'{0}\' \'{1}\' \'{2}\'", description, code, price), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
